...
const AboutUs = () => {
  return (
    <div>
      ...
      data-aos-delay="500"
      className="md:text-5xl text-2xl text-center  font-bold md:font-extrabold mb-6 mx-auto">
                About Us
              </h1>
          ...
          <div className="flex flex-wrap items-center justify-between -mx-4">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                Empowering Change: About Vlolunteer Link
                </h2>
                <p 
                data-aos="fade-up"
                data-aos-duration="500"
                ...
                At Vlolunteer Link, we are dedicated to empowering individuals and organizations to create positive change in their communities through volunteering. Our platform serves as a catalyst for meaningful connections and impactful collaborations, driving social change one volunteer opportunity at a time.
                </p>
                <p
                data-aos="fade-up"
                data-aos-duration="500"
                ...
                With a diverse range of volunteering opportunities spanning various causes and interests, we strive to connect passionate individuals with organizations in need. Whether you are looking to give back, gain valuable experience, or make new connections, we are here to help you find the perfect opportunity to make a difference.
                </p>
                <p
                data-aos="fade-up"
                data-aos-duration="500"
