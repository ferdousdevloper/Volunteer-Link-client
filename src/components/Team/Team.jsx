  ...
  return (
    <div className="container md:mx-auto">
      <div className="p-8 ">
        ...
        data-aos-duration="500"
        data-aos-delay="700"
        className="mb-12 text-xl font-normal text-center text-gray-500 ">
        ...
        className="flex flex-col items-center md:flex-row justify-evenly">
          <div
          data-aos="zoom-in"
          data-aos-duration="500"
          data-aos-delay="1400"
          ...
          className="p-4">
            <div className="mb-4 text-center opacity-90">
              <a href="#" className="relative block">
                <img
                  alt="profil"
                  src="https://i.ibb.co/gyY2sGp/a.jpg"
                  className="mx-auto object-cover rounded-full h-40 w-40 "
                />
              </a>
            </div>
            <div className="text-center">
              <p className="text-2xl">Mohammad Ferdous Hossain</p>
              <p className="text-xl font-light">Founder</p>
              <p className="max-w-xs py-4 font-light text-gray-500 text-md dark:text-gray-400">
                Dedicated to fostering positive change through volunteerism and
                collaboration.
              </p>
            </div>
            <div className="flex items-center justify-between pt-8 mx-auto text-gray-500 border-t border-gray-200 w-44">
          ...
          className="p-4">
            ...
            <div className="text-center">
              ...
              <p className="max-w-xs py-4 font-light text-gray-500 text-md dark:text-gray-400">
                Enthusiastic about making a difference and empowering others to
                join in service initiatives.
              </p>
            </div>
            <div className="flex items-center justify-between pt-8 mx-auto text-gray-500 border-t border-gray-200 w-44">
              <a href="#">
